...
async def api_status(request: Request):
    ...
    return {"service": state.settings.app_name, "database_mode": state.repository.mode, "discord_enabled": state.notifier.discord.enabled, "scheduler_running": bool(state.scheduler and state.scheduler.running), "latest_scan": latest}
